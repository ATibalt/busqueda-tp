...
public class Procesamiento {
    ...
    static String[][][] palabras = {
            ...
            {{"dale", "andale"},{"dale"}},
            {{"mover", "muevo", "mueves", "mueve", "movemos", "mueven", "moves"},{"mover"}},
            ...
            {{"donde"},{"donde"}},
            {{"estar", "esta", "este", "estemos", "estad", "esten", "esta", "estate"},{"estar"}},
            {{"nadie", "ninguno"},{"nadie"}},
            {{"salir", "salgo", "sales", "sale", "salimos", "salen", "salis", "irse", "partir", "ausentarse", "marchar", "huir", "alejarse", "saliendo", "marchando", "huyendo"},{"salir"}},
            ...
            {{"llamar", "llamo", "llamas", "llama", "llamamos", "llamais", "llaman", "llamas", "llamando"},{"llamar"}},
            ...
            {{"llevar", "llevo", "llevas", "lleva", "llevamos", "llevais", "llevan", "llevas", "llevando", "llevame"},{"llevar"}},
            {{"hacer", "hago", "haces", "hace", "hacemos", "haceis", "hacen", "haces", "haciendo", "haceme"},{"hacer"}},
            {{"dañar", "daño", "dañas", "daña", "dañamos", "dañan", "dañas", "dañando"},{"dañar"}},
            {{"pegar", "pego", "pegas", "pega", "pegamos", "pegan", "pegando"},{"pegar"}},
            {{"golpear", "golpeo", "golpeas", "golpea", "golpeamos", "golpean", "golpeas", "golpeando"},{"golpear"}},
